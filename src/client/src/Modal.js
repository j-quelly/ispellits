...
class Modal extends Component {
  render() {
    ...
    if (props.startScreen) {
      return (<StartScreen state={props} onClick={this.props.onClick} />);
    } else if (props.scoreScreen) {
      return (<ScoreScreen state={props} onClick={this.props.onClick} />);
    ...
    return (
      <Screen maxWidth={543}>
        <div className="modal">
          ...
          <Btn onClick={this.props.onClick} btnText={props.btnText} />
        </div>
      </Screen>
      );
  }
